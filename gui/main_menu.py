...
class MainWindow:
    def __init__(self, title, theme, thread, loop):
        ...
        self.root.protocol("WM_DELETE_WINDOW", self.exit_program(thread, loop))
        ...
        self.root.call('wm', 'iconphoto', self.root._w, app_icon)
    ...
    def show_iiko_frame(self):
        ...
        ttk.Button(frame_iiko, text="Добавить аккаунт IIKO",
                   command=lambda: IIKOConnectWindow('Новый аккаунт IIKO')).pack(pady=20)
    ...
    def show_connection_frame(self):
        ...
        for connection in connections:
            connections_tree.insert('', 'end', values=(connection.id,
                                                       connection.iiko_connection.login,
                                                       connection.saby_connection.login,
                                                       'pass'))
