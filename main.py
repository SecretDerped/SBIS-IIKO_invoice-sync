                ...
                if len(sbis_connection) > 0:
                    ...
                    for iiko_login, iiko_password_hash in iiko_connect_list.items():
                        ...
                        try:
                            ...
                            logging.warning(f'Error in the loop: {e, e.args}')

        except Exception as e:
            logging.info(f"Error: {e, e.args}")
